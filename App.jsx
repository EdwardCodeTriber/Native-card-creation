...
const BirthdayCardApp = () => {
    ...
    async function loadFonts() {
      try {
        ...
        await Font.loadAsync({
          'Dancing': fontMap['Dancing'],
          'Pacifico': fontMap['Pacifico'],
          'Montserrat': fontMap['Montserrat']
        });
  ...
  const getImageTransformStyle = () => {
    return [
      { rotate: `${imageRotation}deg` }, // Fix: Convert to string with 'deg'
      { scale: imageScale }
    ];
  };

  // Card content rendering with fixed transform
  ...
  // Image rotation slider with fixed value handling
    ...
    <View style={styles.section}>
      ...
      <View style={styles.sliderContainer}>
        ...
        <Slider
          ...
          maximumValue={360}
          value={imageRotation}
          onValueChange={(value) => setImageRotation(Math.round(value))} // Fix: Round the rotation value
        />
        ...
        <Slider
          ...
          onValueChange={(value) => setImageBorderRadius(Math.round(value))} // Fix: Round the border radius value
        />
      </View>
    </View>
  );
  ...
  return (
    ...
    <ScrollView>
      ...
      {selectedImage && renderImageControls()}
